    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body product-details1-mobile">
            ...
            <div class="product-list-mobile">
                ...
                @endforeach
                <!-- <div><a href="">Customized Gift Hampers <span class="list-count">(90)</span></a></div>
                    <div><a href="">Keychains <span class="list-count">(100)</span></a></div>
                    <div><a href="">Lamps and Torches <span class="list-count">(50)</span></a></div>
                    <div><a href="">Steel bottles <span class="list-count">(20)</span></a></div>
                    <div><a href="">Eco-friendly gifting <span class="list-count">(50)</span></a></div>
                    <div><a href="">Notebooks <span class="list-count">(50)</span></a></div>
                    <div><a href="">Tea coasters <span class="list-count">(50)</span></a></div> -->
            </div>
        </div>
    </div>
    ...
    <div class="row product-list-main">
        <div class="col-md-3 product-details1">
            ...
            <div class="product-list">
                ...
                <div><a href="{{ url('products',$category->slug_category_name) }}">{{ ucfirst($category->category_name) }} <span class="list-count">({{ $category->product_count }})</span></a></div>
                @endforeach
                <!-- <div><a href="">Bags <span class="list-count">(10)</span></a></div>
                    <div><a href="">Customized Gift Hampers <span class="list-count">(90)</span></a></div>
                    <div><a href="">Keychains <span class="list-count">(100)</span></a></div>
                    <div><a href="">Lamps and Torches <span class="list-count">(50)</span></a></div>
                    <div><a href="">Steel bottles <span class="list-count">(20)</span></a></div>
        ...
        <div class="col-md-9 product-details2">
            <div class="product-list-border">
                <div class="row">
                    <h6 class="">{{ strtoupper($category_name->category_name) }}</h6>

                    <form id="sorting-form" action="{{ route('website.sort', ['cat_name' => $category_name->slug_category_name]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="float-end my-2">
                            <select class="product-filter-select" name="sort" onchange="submitForm()" style="border: none;outline:none;">
                                <option value="0" {{ $selected_sorting_option == 0 ? ' selected' : '' }}>Default Sorting</option>
                                <option value="1" {{ $selected_sorting_option == 1 ? ' selected' : '' }}>Sort by popularity</option>
                                <option value="2" {{ $selected_sorting_option == 2 ? ' selected' : '' }}>Sort by latest</option>
                                <option value="3" {{ $selected_sorting_option == 3 ? ' selected' : '' }}>Sort by price: low to high</option>
                                <option value="4" {{ $selected_sorting_option == 4 ? ' selected' : '' }}>Sort by price: high to low</option>
                            </select>
                        </div>
                    </form>
                </div>
